let descriptionsES = [
    ...
    [
        ...
        '<iframe src="https://player.vimeo.com/video/649699885?h=fd9f868924&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="TRAMA No te tiene que doler (bajada final, 10,11,21, VBR 16-40).mp4"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>',
...
let descriptionsEN = [
    ...
    [
        ...
        "assets/images/thumbnails/No te tiene que doler 16-9 Dibujo.jpg",
        '<iframe src="https://player.vimeo.com/video/629299340?h=16d2f4cec7&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="TRAMA No te tiene que doler (bajada final, 10,11,21, VBR 16-40).mp4"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>',
        'With: Lis Tejón, Edu Anderson, Mumi Rujana \n Direction, production, editing: Jada Sirkin, Dama David \n Script: Dama David, Jada Sirkin, Lis Tejón, Edu Anderson, Mumi Rujana \n Camera: Jada Sirkin, Magalí Aldabe \n Direct sound: José Ratti, Huber Cabello, Bayron Mendivelso \n Art: Magalí Aldabe \n Production assistance: Sharon Cohen Golrdfrid, Malena Morandini \n Still photo: Malena Morandini \n Lighting assistance: Toki Pfannkuche, Leonel Luciani \n Sound post production: Zub sonido - Emiliano Biaiñ, Marcos Zoopi, Facundo de Vedia \n Opening drawing and paintings: Cuno Sztark \n Translation: Adrián Gleizer \n Music: Mumi Rujana'
    ],
    [
        'Em leaves the theater',
        '55 min',
        "Em sells the theater, her life project. What remains is rain, animals, pianos, friends, useless attempts to make sense.",
        "assets/images/thumbnails/TRAMA Em Still 110 (corregida).jpg",
        '<iframe src="https://player.vimeo.com/video/631418639" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="TRAMA No te tiene que doler (bajada final, 10,11,21, VBR 16-40).mp4"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>',
        'With: Mizu Desierto, Kelly Nesbitt, Stephanie Lanckton, Lolo Haha, Draven Chase, Kennedy, Ariel Bittner, Ira Echo, Karla Mi Lugo, Paula Helen \n Production: Jada Sirkin, Dama David, Mizu Desierto \n Direction, editing: Jada Sirkin, Dama David \n Script: Jada Sirkin, Dama David, Camila Torres, Mizu Desierto, Kelly Nesbitt, Stephanie Lanckton, Lolo Haha \n Camera and color: Jada Sirkin \n Direct sound: Dama David, Stephanie Lanckton, Kelly Nesbitt \n Sound post production: Zub sonido - Emiliano Biaiñ, Marcos Zoopi, Facundo de Vedia \n Production assistance: Kelly Nesbitt, Stephanie Lanckton \n Music: Mad Composer Lab, Carly Bates, Yaara Valey, Karla Mi Lugo, Stephanie Lanckton, Roland Toledo (a.k.a. Alter Structure), Ira Echo'
    ],
    [
        'Mission Distance',
        '36min',
    ...
    [
        ...
        '46 min',
        "October 2019. Max is moving to another country, but it's the others who are moving. Ana, Caro, Uli, Teo, Sabrina, Andi, Lili, Javiera, the Chilean people. Javiera has just arrived in Buenos Aires, she comes from participating in the revolt in Chile, she wants hugs and she wants war.",
        "assets/images/thumbnails/TRAMA Una inestabilidad Still 1.jpg",
        '<iframe src="https://player.vimeo.com/video/635702551?h=4f70e73e00" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="TRAMA No te tiene que doler (bajada final, 10,11,21, VBR 16-40).mp4"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>',
        'With: Denisse Bustos, Dama David, Pato Balado, Camila Torres, Julián Ekar, Gustavo Urroz, Ludmila Man, Sharon Cohen Goldfrid, Taiu Braver Iosovich, Sebastián Minces, Sara Jiménez Molina, Anderson Mendoza, Rafael Laureiro, Jésica Ferro, Gordon, Amigo \n Direction, production, editing: Jada Sirkin, Dama David \n Camera and color: Jada Sirkin \n Direct sound: José Ratti, Bayron Mendivelso, Dama David, James Vallejo Mejía, Gustavo Urroz, Julián Ekar. \n Sound post production: Zub sonido - Emiliano Biaiñ, Marcos Zoopi, Facundo de Vedia \n Still photo and production assistance: Malena Morandini \n Transcription: Magdalena Chattah \n Music: Joaquín Merino'
    ],
    [
        'The alley',
        '1h 1m',
    ...
    [
        ...
        "https://i.pinimg.com/originals/47/7b/7c/477b7c1c999a42694b936fd191279b84.gif",
        '<iframe src="https://player.vimeo.com/video/640757048?h=1fb0ffc775&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479 frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="TRAMA No te tiene que doler (bajada final, 10,11,21, VBR 16-40).mp4"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>',
        'With: Sol Bordigoni, Jada Sirkin, Mumi Rujana, Rita Messina, Magalí Aldabe, Hernán Bustamante, Sharon Cohen Goldfrid, Jazmín Ruffo, Wem Wertheimer, Keni, Toni \n Direction, production, editing:: Dama David, Jada Sirkin \n Script:: Jada Sirkin, Dama David, Denisse Bustos, Sol Bordigoni, Rita Messina, Mumi Rujana \n Art assistance: María Morín \n Camera: Dama David, Jada Sirkin \n Direct sound: Denisse Bustos, Camila Torres, Elsa Wirth, Dama David, Sharon Cohen Goldfrid, Wayra Inti, Facundo Martin, Julián Hercovich. \n Sound post production: Zub sonido - Emiliano Biaiñ, Marcos Zoppi, Facundo de Vedia \n Transcription: Magdalena Chattah \n Music: Eduardo Felenbok, Mumi Rujana, Jada Sirkin'
    ],
]